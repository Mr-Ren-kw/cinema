...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\IntelliJ IDEA 2019.1.3\\workspace\\project3\\cinema\\guns-order\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_cinema_t","mtime_film_t","mtime_field_t"});
