...
public class FilmController {
    ...
    public BaseFilmResponseVo queryFilmById(@PathVariable("filmId") Integer filmId) {
        Object getFilms = cacheService.get("films_"+filmId);
        if (getFilms != null) {
            return (BaseFilmResponseVo) getFilms;
        }
        ...
        cacheService.set("films_"+filmId,baseFilmResponseVo);
        return baseFilmResponseVo;
    }
    @RequestMapping("/getIndex")
    public BaseFilmResponseVo getIndex() {
        Object getFilmsIndex = cacheService.get("films_index");
        if (getFilmsIndex != null) {
            return (BaseFilmResponseVo) getFilmsIndex;
        }
        ...
        cacheService.set("films_index",response);
        return response;
    }
