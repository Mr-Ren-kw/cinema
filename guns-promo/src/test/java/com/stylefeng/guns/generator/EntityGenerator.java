...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("E:\\Java_demo\\IDEA\\workspace\\cinema\\guns-promo\\src\\main\\java");//这里写你自己的java目录
        ...
        strategy.setInclude(new String[]{"mtime_promo","mtime_promo_order","mtime_promo_stock"});
